...
const initReviewsSwiper = () => {
  const swiper = new Swiper(`.${REVIEWS_SLIDER_CLASS}`, {
    ...
    breakpoints: {
      [_const_js__WEBPACK_IMPORTED_MODULE_1__.Width.XL]: {
    ...
    breakpoints: {
      [_const_js__WEBPACK_IMPORTED_MODULE_1__.Width.XXL]: {
...
const handleSwiperMode = (initSwiper) => {
  ...
  const setSwiperMode = () => {
    const isDestroyWidth = window.matchMedia(`(min-width: ${_const_js__WEBPACK_IMPORTED_MODULE_0__.Width.XL}px)`).matches;
